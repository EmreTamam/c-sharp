...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine(DateTime.Now.ToString("MMMM"));//Apri4
        ...
        Console.WriteLine(Math.Pow(2,3)); //Üs 2^3 
        Console.WriteLine(Math.Sqrt(9)); // Karekök 81
        Console.WriteLine(Math.Log(9)); // e tabanında 9
        Console.WriteLine(Math.Exp(3)); //e üzeri 3
        Console.WriteLine(Math.Log10(10)); //log10 tabanında 10
